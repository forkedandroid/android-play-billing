package com.ccavenuesample.testotpappnew;
...
import com.ccavenuesample.adapter.CardAdapter;
import com.ccavenuesample.adapter.CardNameAdapter;
import com.ccavenuesample.adapter.EMIAdapter;
import com.ccavenuesample.adapter.EMIPlansDTO;
import com.ccavenuesample.adapter.PayOptAdapter;
import com.ccavenuesample.dto.CardTypeDTO;
import com.ccavenuesample.dto.EMIOptionDTO;
import com.ccavenuesample.dto.PaymentOptionDTO;
import com.ccavenuesample.utility.AvenuesParams;
import com.ccavenuesample.utility.Constants;
import com.ccavenuesample.utility.ServiceHandler;
import com.ccavenuesample.utility.ServiceUtility;
            ...
            if (vJsonStr!=null && !vJsonStr.equals("")) {
                try {
                    ...
                    if(jsonRespObj!=null){
                        ...
                        if(jsonRespObj.has("EmiBanks")==true
                                && (jsonRespObj.getString("EmiBanks")!=null
                                && jsonRespObj.getString("EmiBanks").length()>0)
                                &&(jsonRespObj.getString("EmiPlans")!=null
                                && jsonRespObj.getString("EmiPlans").length()>0)
                                )
                        {
